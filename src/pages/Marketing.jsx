...
export default function Marketing() {
  ...
  useEffect(() => {
    const fetchSheets = async () => {
      try {
        const data = await sheetService.getSheets('DIGITAL');
        setSheets(data);
      } catch (err) {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      <h1 className="text-2xl font-bold text-green-600 mb-4">Marketing Sheets</h1>
      <AddSheetForm onAdd={handleAddSheet} type="DIGITAL" />
